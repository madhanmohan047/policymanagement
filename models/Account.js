...
const accountSchema = new mongoose.Schema({
    ...
    accountHolder: { type: String, ref: 'Contact', required: [true, 'Account holder is required'] }, 
    primaryLocation: { type: String, ref: 'Address', required: [true, 'Primary location is required'] },
    status: { 
        code: { type: String, required: true }, 
        name: { type: String, required: true } 
    },
    organization: { type: String, ref: 'Organization', required: [true, 'Organization is required'] },
    producerCode: { type: String, ref: 'ProducerCode', required: [true, 'Producer code is required'] },
